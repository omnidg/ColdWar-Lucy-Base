runMenuIndex(menu)
{
    ...
    switch(menu)
    {
        ...
        case "Wonder Weapons":
            self addMenu(menu, "Wonder Weapons");
            for(z=0;z<level._AllWonders.size;z++)
                self addOpt(level._AllWonderNames[z], &GiveClientWeapon, level._AllWonders[z], self);
        break;
        case "Upgraded Wonder Weapons":
            self addMenu(menu, "Upgraded Wonder Weapons");
            for(z=0;z<level._AllWonders.size;z++)
                self addOpt(level._AllWonderNames[z], &GiveClientWeapon, level._AllWonders[z]+"_upgraded", self);
        break;
        case "Skin Selection":
